  ...
  // Check that the user entered a message and is signed in.
    ...
    if(this.messageInput.value && this.checkSignedInWithMessage()){
     ...
     this.messagesRef.push({ 
        ...
        //Clear message test field and SEND button state.
      
        FriendlyChat.resetMaterialTextfield(this.messageInput);
        this.toggleButton();
     }.bind(this)).catch(function(error){ 
        console.error('Error Saving new message to the datatbase', error);
     });
...
//we add a message with loading icon
  ...
  /*
    var currrentUser = this.auth.currentUser;
   alert('try2');
    this.messagesRef.push({
        name: currentUser.displayName,
        imageUrl: FriendlyChat.LOADING_IMAGE_URL,
        ...
        uploadTask.on('state_changed', null, function(error){
            console.error('There was an error uploadiing a file: ', error);
            alert('try2' + error);
        }, function(){
